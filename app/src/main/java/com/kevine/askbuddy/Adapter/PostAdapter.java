package com.kevine.askbuddy.Adapter;
...
import com.kevine.askbuddy.CommentActivity;
import com.kevine.askbuddy.FollowersActivity;
import com.kevine.askbuddy.Fragments.PostDetailFragment;
import com.kevine.askbuddy.Fragments.ProfileFragment;
import com.kevine.askbuddy.Model.Post;
import com.kevine.askbuddy.Model.User;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.Viewholder> {
    ...
    private void getComments (String postId, final TextView text) {
        FirebaseDatabase.getInstance().getReference().child("Comments").child(postId).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                text.setText(dataSnapshot.getChildrenCount() + " Answers");
            }
